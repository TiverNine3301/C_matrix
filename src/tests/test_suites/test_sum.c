...
START_TEST(sum_matrix_1) {
  ...
  A.matrix[1][0] = 1, A.matrix[1][1] = 1;
  B.matrix[0][0] = 3, B.matrix[0][1] = 3;
  B.matrix[1][0] = 3, B.matrix[1][1] = 3;
...
START_TEST(sum_matrix_7) {
  ...
  s21_create_matrix(rows, cols, &res_origin);
...
Suite *suite_sum_matrix() {
  Suite *suite = suite_create("\x1b[34m[s21_s21_sum_matrix]\x1b[0m");
  TCase *tcase_core = tcase_create("s21_sum_matrix_tc");
  ...
  tcase_add_test(tcase_core, sum_matrix_5);
  tcase_add_test(tcase_core, sum_matrix_6);
  tcase_add_test(tcase_core, sum_matrix_7);
  tcase_add_test(tcase_core, sum_matrix_8);
